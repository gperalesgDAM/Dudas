        ...
        try {
            ...
            while (true) {
                ...
                try {
                    ...
                    //*************************RECIBIR EL MENSAJE DEL CLIENTE (SALUDO Y NÚMERO)************************************
                    ...
                    //***********************MOSTRAR POR PANTALLA COMO SE HA ENVIADO(SALUDO Y NÚMERO)***********************************
                    System.out.println("Servidor ha enviado un objeto con el número: " + ObjetoClienteEnviar.getNumero()); //Solo ponemos el número porque es lo que va a mostrar el servidor
                    //*************************************************************
                    //-----------------------------------------------------------------------------------------------------------------
